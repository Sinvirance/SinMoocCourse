...
/**
 * @Author: Sinvirance
 * @Date: 2021/1/25 23:13
 * @Description: 操作数据库及表信息工具类
 */
...
public class DbUtil {
    ...
    /**
     * 数据表字段名下划线转小驼峰变量名：course_id => courseId
     * @param str 待转换的数据表字段名
     * @return 转化后的变量名
     */
    ...
    /**
     * 数据表字段名下划线转大驼峰变量名：course_id => CourseId
     * @param str 待转换的数据表字段名
     * @return 转化后的变量名
     */
