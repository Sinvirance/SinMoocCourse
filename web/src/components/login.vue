          ...
          <div class="login-div" v-show="MODAL_STATUS === STATUS_LOGIN">
            ...
            <div class="form-group">
              <div class="checkbox">
                ...
                <div class="pull-right switch-page">
  ...
  export default {
    ...
    methods: {
      ...
      sendSmsForRegister() {
        let _this = this;
          ...
          use: SMS_USE.REGISTER.key
				...
				_this.$ajax.get(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist/' + _this.memberRegister.mobile).then((resp)=>{
      ...
      sendSmsCode(sms, btnId) {
        ...
        // 调服务端发短信接口
        _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/web/sms/send', sms).then((resp)=> {
          let response = resp.data;
          if (response.success) {
            Toast.success("短信已发送");
