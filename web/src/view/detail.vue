        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" data-target="#info" data-toggle="pill">课程介绍</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-target="#chapter" data-toggle="pill">章节目录</a>
              </li>
            </ul>
                      ...
                      <tr v-for="(s, j) in chapter.sections" class="chapter-section-tr">
                        <td class="col-sm-8 col-xs-12">
                          <div v-on:click="play(s)" class="section-title">
                            ...
                            {{s.title}}
                            <span v-show="s.charge !== SECTION_CHARGE.CHARGER.key" class="badge badge-primary hidden-xs">免费</span>
                          </div>
                        </td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      play(section) {
        let _this = this;
        if (section.charge === _this.SECTION_CHARGE.CHARGER.key ) {
