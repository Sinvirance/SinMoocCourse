# SinMoocCourse
An online video learning website modeled after IMooC Based on Spring Cloud
...
```
git clone ssh://git@github.com:Sinvirance/SinMoocCourse.git
```
...
npm install
```
* 新建数据库coursemooc，数据库链接和密码根据个人情况，修改 application.properties 配置文件
